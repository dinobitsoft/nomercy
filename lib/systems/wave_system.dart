...
class WaveSystem {
  ...
  void _rewardPlayer() {
    ...
    final oldHealth = game.player.health;
    game.player.health = (game.player.health + healAmount).clamp(0, 100);
    final actualHeal = game.player.health - oldHealth;
