...
class Projectile extends PositionComponent with HasGameRef<ActionGame> {
  ...
  final double damage;
  final double speed; // New configurable speed
  ...
  Projectile({
    ...
    this.speed = 400.0, // Default value if not specified
    this.owner,
    this.enemyOwner,
    required this.color,
  ...
  void update(double dt) {
    ...
    // Move projectile using the configurable speed
    ...
    if (enemyOwner != null && game.player != null) {
