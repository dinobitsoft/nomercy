...
class _CharacterSelectionScreenState extends State<CharacterSelectionScreen>
  ...
  void _scrollCarousel(int delta) {
    final next =
    (_currentPage + delta).clamp(0, characterOptions.length - 1);
  ...
  Widget _buildStatBars(CharacterStats stats) {
    return Column(
      children: [
        _buildStatBar('STR', stats.power, Colors.red),
        const SizedBox(height: 4),
        _buildStatBar('AGI', stats.dexterity, Colors.green),
        const SizedBox(height: 4),
        _buildStatBar('INT', stats.intelligence, Colors.blue),
      ],
    );
  }
