...
class PlatformFactory {
  ...
  /// Create platform based on current quality settings
  GamePlatform createPlatform({  // ✅ Changed from PositionComponent
  ...
  GamePlatform _createPlatformByQuality({  // ✅ Changed from PositionComponent
    required Vector2 position,
    required Vector2 size,
    required String platformType,
  ...
  List<GamePlatform> createBatch({  // ✅ Changed from List<PositionComponent>
    required List<PlatformData> platformDataList,
    PlatformQuality? batchQuality,
  }) {
    final platforms = <GamePlatform>[];  // ✅ Changed type
